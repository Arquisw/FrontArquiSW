...
export class ProyectosService {
  ...
  public consultarProyectos(): Observable<ProyectoResumen[]>
  {
    return this.httpService.doGet<ProyectoResumen[]>(`${environment.endpoint}${this.NECESIDADES_ENDPOINT}${this.PROYECTOS_ENDPOINT}/`);
  }
